        ...
        <div class="content-wrapper">
          <div class="row">
            ...
            <div class="col-12 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  <h3>View Order Received By Fuel Station</h3>
                 <br>
                  <form class="forms-sample" method="post" action="between-date-reprtsdetails.php">
                   ...
                   <div class="form-group">
                     ...
                     <select class="form-control" id="fuelsta" name="fuelsta" value="" required='true' onChange="getCity(this.value);">
                         ...
                         <?php 
$sql2 = "SELECT tblfuelstation.ID,tblfuelstation.OwnerID,tblfuelstation.NameoffuelStation,tblfuelstationowner.FullName from   tblfuelstation join  tblfuelstationowner on tblfuelstationowner.ID=tblfuelstation.OwnerID";
...
{          
    ?>  
<option value="<?php echo htmlentities($row->ID."$".$row->NameoffuelStation);?>"><?php echo htmlentities($row->NameoffuelStation);?>(Owner Name: <?php echo htmlentities($row->FullName);?>)</option>
 <?php } ?> 
                       </select>
                    </div>
                 <br>
