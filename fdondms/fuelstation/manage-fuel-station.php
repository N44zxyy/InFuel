...
$query->execute();
 echo "<script>alert('Data deleted');</script>"; 
  echo "<script>window.location.href = 'manage-fuel-station.php'</script>";     
...
{               ?>
                         <td><?php echo htmlentities($cnt);?></td>
                                        ...
                                        <td><a class="btn btn-sm btn-primary" href="edit-fuel-station.php?editid=<?php echo htmlentities ($row->fsid);?>">Edit</a>
                                          <a class="btn btn-sm btn-danger" href="manage-fuel-station.php?delid=<?php echo ($row->fsid);?>"  onclick="return confirm('Do you really want to Delete ?');">Delete</a></td>
                        </tr>
                        <?php $cnt=$cnt+1;}} ?>
                      </tbody>
                    </table>
