...
$sql ="SELECT ID FROM tblfuelstationowner WHERE ID=:uid and Password=:cpassword";
...
if($query -> rowCount() > 0)
{
$con="update tblfuelstationowner set Password=:newpassword where ID=:uid";
...
<head>
  ...
  <title>Fuel Delivery Management System|| Change Password</title>
  <!-- base:css -->
