...
<head>
  ...
  <title>Fuel Delivery Management System ||Cancelled Order</title>
  <!-- base:css -->
...
<?php } else { ?>                  <td><?php  echo htmlentities($row->Status);?>
                  ...
                  <td><?php  echo htmlentities($row->OrderDate);?></td>
                                        ...
                                        <td><a href="view-order-detail.php?editid=<?php echo htmlentities ($row->orderid);?>&&oid=<?php echo htmlentities ($row->ordernum);?>"><i class="icon-eye" aria-hidden="true"></i></a></td>
                        </tr>
